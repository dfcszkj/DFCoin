...
public class AnnotationHelper {
	...
	public static List<Class> findClasses(Class clazz) {
        ...
        //file:/D:/work/ALTSys/src/main/webapp/WEB-INF/classes/
        URL classPathUrl = AnnotationHelper.class.getResource("/");
...
//      String lib = new File(classPathUrl.getFile()).getParent() + "/lib/";
    ...
    /**
     * get the full class name with package, such as: com.filentech.base.BaseController
     * @param classFile
     * @param pre
     * @return
     */
    private static String className(File classFile, String pre) {
        ...
        String className = objStr.substring(objStr.indexOf(pre) + pre.length(), objStr.indexOf(".class"));
